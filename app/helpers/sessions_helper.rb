module SessionsHelper
    ...
    def signed_in_customer
      unless signed_in?
        store_location
        redirect_to signin_url, :flash => { :error => "Please sign in." }
      end
    end
            ...
            [
                {
                    ...
                    [
                        { 
                            ...
                            :HiResImage => "http://www.picturesofcats4you.com/wp-content/uploads/2008/06/funny-cat-wallpapers-7.jpg", 
                            :CropMode => "FILLIN"
                        }
                    ]
                }
